"use client";
import { crearMovimiento } from "@/app/actions/MovimientosActions";
...
export default function Home() {
  ...
  const handleMovimientoSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setMovimientos([...movimientos, nuevoMovimiento as Movimiento]);
      setMovimientoForm({
        ...movimientoForm,
        cantidad: 0,
        precioUnitario: 0,
  ...
  return (
    <div className="grid items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <h1 className="text-2xl font-bold mb-4">
        Sistema Kardex (Demo en memoria)
      </h1>
      {/* Formulario de productos */}
      <form
        onSubmit={handleProductoSubmit}
        className="mb-8 p-4 border rounded flex flex-col gap-2 w-full max-w-md"
      >
